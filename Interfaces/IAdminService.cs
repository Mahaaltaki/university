...
namespace kalamon_University.Interfaces
{
    ...
    {
        // --- User Profile Management (Called by AuthService after user creation) ---
        Task<ServiceResult> CreateStudentProfileAsync(Guid userId);
        Task<ServiceResult> CreateProfessorProfileAsync(Guid userId, string specialization);
